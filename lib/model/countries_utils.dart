class CountriesUtils {
  ...
  static Map<String, String> seperatePhoneAndDialCode(String phoneWithDialCode) {
    Map<String, String> foundedCountry = {};
    for (var country in CountriesUtils.allCountries) {
    ...
    if (foundedCountry.isNotEmpty) {
      ...
      return foundedCountry..putIfAbsent('phone', () => newPhoneNumber);
    }
    else{
      return {"name": "Egypt", "dial_code": "+20", "code": "EG",'phone':''};
    }
  }
}