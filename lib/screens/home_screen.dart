            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Consumer<HomeProvider>(
                    builder: (context, value, child) => Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: value.categories == null
                              ? 0
                              : value.categories!.length,
                          itemBuilder: (c, i) {
                            return CategoryWidget(
                              category: value.categories![i],
                              isSelected: value.selectedHomeIndex == i,
                              onTap: () {
                                value.selectHomeIndex(i);
                              },
                            );
                          }),
                    ),
                  ...
                  Text(
                      'Best deals from Payback partners that might be interesting to you'),
                  SizedBox(
                    height: 10,
                  ),
                  Consumer<HomeProvider>(
                    builder: (c, v, child) => v.hotDealsProducts.isEmpty
                        ? Container()
                        : Container(
                            height: 300,
                  ...
                  Text(
                      'Check products with best cashback percentage to cover your commitments'),
                  SizedBox(
                    height: 10,
                  ),
                  Consumer<HomeProvider>(
                    builder: (c, v, cc) => v.suggestedProducts.isEmpty
                        ? Container()
                        : Container(
                            height: 300,
                            width: double.infinity,
...
class RPSCustomClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.2802000, size.height * 0.4017000,
        size.width * 0.2802000, size.height * 0.3772000);
    path.quadraticBezierTo(size.width * 0.2924500, size.height * 0.3772000,
        size.width * 0.2980000, size.height * 0.3020000);
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.quadraticBezierTo(size.width * 0.2802000, size.height * 0.4017000,
        size.width * 0.2802000, size.height * 0.3772000);
    path_0.quadraticBezierTo(size.width * 0.2924500, size.height * 0.3772000,
        size.width * 0.2980000, size.height * 0.3020000);
