        ...
        child: Wrap(
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.all(16),
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(16),color: kBlueLightColor),
              child: Column(
                children: [
                  ListTile(
                    ...
                    leading: Container(
                      width: 56,
                      height: 56,
                  decoration: BoxDecoration(image:DecorationImage(image: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuCxMPJwglskH6j6jQhCmJGqIr9kR6_iMPng&usqp=CAU',),fit: BoxFit.cover),borderRadius: BorderRadius.circular(10)),),title: Text('Partner name goes here',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.black),),)
                  ,SizedBox(height: 10,)
                  ,Text('A trattoria is an Italian-style eating establishment that is generally much less formal than a ristorante, but more formal than an osteria.')
                ]
                ,
              ),
            ),
            ...
            Container(height: 20),
            Text('Partner products',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            Container(height: 10,),
            Container(
              height: 100,
