...
class CommitmentsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(backgroundColor:Colors.grey.shade200,leadingWidth:double.infinity,leading: Align(alignment:Alignment.centerLeft,child: TextButton.icon(onPressed: (){}, icon: Icon(Icons.arrow_back_ios), label: Text('Back'),)),),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text('Priority',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          Text('Edit order',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: kBlueColor),),
                        ],
                      ),
                      SizedBox(height: 20,),
                      Column(
                        children:                   List.generate(5, (index) => Container(margin:EdgeInsets.symmetric(vertical: 4),child: Commitment()))
                        ,
                      )
,
              ...
              Container(
                ...
                child:   Container(
                    ...
                    child: CustomButton(buttonText: '+ Add new commitment', buttonColor: kPurpleColor)),
              )
              ,
            ],
          ),
