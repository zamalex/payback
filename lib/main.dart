...
void _readShowSubscribe() async {
  DatabaseEvent snapshot = await databaseReference.child('showSubscribe').once();
  Url.showSubscribe = ((snapshot.snapshot.value??true) as bool?)??true;

  snapshot = await databaseReference.child('showAppleSignin').once();
  Url.showApple = ((snapshot.snapshot.value??true) as bool?)??true;

  snapshot = await databaseReference.child('showGoogleSignin').once();
  Url.showGoogle = ((snapshot.snapshot.value??true) as bool?)??true;
